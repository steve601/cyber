...
## Overview
->Main purpose of this application is to classify tweets posted on 'X' platform as cyberbulling or not, and if cyberbullying, it classifies them into various types of cyberbullying
...
1. **Clone the repository**:
    ```sh
    git clone https://github.com/steve601/cyber.git
    cd cyber
    ```
